...
See [the Code documentation]({{ site.baseurl }}{% link guide/ui-components/code.md %}#mermaid-diagram-code-blocks) for more configuration options and information.
...
See [Navigation Structure]({{ site.baseurl }}{% link guide/navigation-structure.md %}#external-navigation-links) for more details.
...
See [Customization]({{ site.baseurl }}{% link guide/customization.md %}) for more information.
...
See [Callouts]({{ site.baseurl }}{% link guide/ui-components/callouts.md %}) for more information.
